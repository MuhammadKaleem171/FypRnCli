...
const UpdateExecute = (props) => {
    ...
    const mData=()=>{
        ...
        try{
            const QData=JSON.stringify({
                ...
                DatabaseName:props.route.params.DatabaseName,
                Query:props.route.params.Query,
              TableName:props.route.params.TableName
            })
            console.log(QData)
            fetch(`http://192.168.1.18/backend/api/values/UpdateQueryExecute`, {
       method: 'POST',
       headers: {
     ...
     console.log(e)
       ...
       const SubmitQuestion=()=>{
         ...
         fetch(`http://${IpAddress}/backend/api/Student/PostAssignment`, {
    method: 'POST',
    headers: {
      Accept: 'application/json',
      'Content-Type': 'application/json'
 ...
 return(
    ...
    <View style={{marginTop:20,marginLeft:10}}>
      <Text style={{fontSize:16,padding:10}}>  Update {props.route.params.TableName}  {props.route.params.Query}</Text>
    </View>
