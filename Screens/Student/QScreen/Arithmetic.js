        ...
        <ScrollView style={{position:'relative'}}>
            <View style={{marginTop:10}}>
              ...
              <Text style={styles.syntax}>
                  Syntax of  Arithmetic Expressions and Operators and Column Aliasing
              </Text>
              <Text>
              SELECT column_name(s) , Arithmetic Expressions  As [ Alias_name ] FROM table_name
              </Text>
              </View>
...
{/* --------------------------Select Arithmetic Expressions ----------------------- */}
  ...
  <View>
      <View>
      <Text style={styles.heading1}> Select Arithmetic Expressions </Text>
      </View>
      <View>
          <Picker 
          ...
          dropdownIconColor="#21130d" 
          mode="dropdown"
          selectedValue={ArithmeticEx}
          onValueChange={(item)=>{
              setArithmeticEx(item)
              console.log('clicked',item)
            }}
          >
          {
              ArithExpression.map((data,index)=>{
              return(  <Picker.Item  key ={index }  value={data.Ex} label={data.Ex}/>)
              })
          }
          </Picker>
      </View>
